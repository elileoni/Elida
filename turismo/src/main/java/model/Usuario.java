...
public class Usuario {
	...
	public List<Producto> obtenerItinerario() throws SQLException {
		UsuarioDAOImpl userDAO = new UsuarioDAOImpl();
		this.itinerario = userDAO.filtrarProductos(this);
	...
	public List<Producto> consultarItinerario(List<Atracciones> productos, Usuario user) throws SQLException {
		...
		if (uDAO.consultaPrimerUso(user) >= 1) {
			user.cargarItinerario(uDAO.filtrarProductos(user));
		}
